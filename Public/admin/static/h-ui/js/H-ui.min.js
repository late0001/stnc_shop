...
!function($){
	...
	!function($){
		var Tooltip=function(element,options){
			...
			Tooltip.DEFAULTS={animation:true,placement:"top",
			selector:false,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',
			trigger:"hover focus",
			title:"",
			delay:0,
			html:false,
							...
							Tooltip.prototype.applyPlacement=function(offset,placement){
								...
								$.offset.setOffset($tip[0],$.extend({
									using:function(props){
										$tip.css({top:Math.round(props.top),
